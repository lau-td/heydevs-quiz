...
export interface ApiQuizQuiz extends Schema.CollectionType {
  ...
  attributes: {
    ...
    questions_number: Attribute.Integer &
      Attribute.Required &
      Attribute.SetMinMax<
        {
          min: 1;
    ...
    >;
    quiz_takes: Attribute.Relation<
      'api::quiz.quiz',
      'oneToMany',
      'api::quiz-take.quiz-take'
    >;
    position: Attribute.String & Attribute.Required;
    level: Attribute.Enumeration<['Intern', 'Junior', 'Middle', 'Senior']> &
      Attribute.Required;
...
export interface ApiQuizTakeQuizTake extends Schema.CollectionType {
  ...
  attributes: {
    ...
    quiz: Attribute.Relation<
      ...
      'api::quiz.quiz'
    >;
    passCode: Attribute.String;
    url: Attribute.String & Attribute.Unique;
    email_sent: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    send_candidate_invitation_email: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiTakeQuestionAnswerTakeQuestionAnswer
  extends Schema.CollectionType {
  collectionName: 'take_question_answers';
  info: {
    singularName: 'take-question-answer';
    pluralName: 'take-question-answers';
    displayName: 'Take Question Answer';
    description: '';
  };
  options: {
    draftAndPublish: false;
